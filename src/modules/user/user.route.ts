...
userRouter.get("/", authenticate, userController.getAllUsers.bind(userController));
...
userRouter.get("/:id", authenticate, validateIdParam(), userController.getUserById.bind(userController));
...
userRouter.delete("/:id", authenticate, validateIdParam(), userController.deleteUser.bind(userController));
